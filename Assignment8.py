...
m=MovieDetails('John Wick' , 2014 , 7.3 )
m.add('An ex-hitman comes out of retirement to track down the gangsters that killed his dog and took everything from him.')
m.display()
...
class Animal:
    ...
    def animal_attribute(self):
        print('The tiger (Panthera tigris) is the largest cat species, most recognizable for its pattern of dark vertical stripes on reddish-orange fur with a lighter underside\n')
class Tiger(Animal):
    pass
